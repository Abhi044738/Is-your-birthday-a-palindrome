  ...
  function clickHandler(e){
    ...
    if (bdayStr!==""){
      ...
      if(isPalindrom){
        ...
        result.innerText="Next palindrome date is "+nextDate[1].day+'-'+nextDate[1].month+'-'+nextDate[1].year+"you missed it by "+nextDate[0]+"\n"+"previous palindrome date is "+previousDate[1].day+'-'+previousDate[1].month+'-'+previousDate[1].year+"you missed it by "+previousDate[0]
      }
    }
  }
